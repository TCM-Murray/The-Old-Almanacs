...
LUA_PATCHER.VERSION = "4.2.2" -- to dev: remember to also update addon.json!
LUA_PATCHER.VERSION_DATE = "2025-11-12"
...
if gmod
    ...
    ConVarLogging = CreateConVar "lua_patcher_logging",
        "1",
        FCVAR_ARCHIVE,
        "Logs errors prevented by Lua Patcher."
    ...
    LogError = (...) ->
        if not LUA_PATCHER.convars_initialized or ConVarLogging\GetBool!
...
if gmod
    ...
    hook.Add "Initialize", "lua_patcher", ->
        ...
        LUA_PATCHER.convars_initialized = true
        return
